...
//  std::cout << "This is the IK result of the naive model." << std::endl;
//
...
//  std::cout << "q_vec#" << "fwd_kin_solve() --- affine_gripper_wrt_base.translation():" << std::endl;
//  std::cout << affine_gripper_wrt_base.translation() << std::endl << std::endl;
//  std::cout << "Expect the see this exactly the same as the one that uses fwd_kin_solve(q_vec)." << std::endl;
//
//
