...
//make this global, so callback can use it:
...
{ 
    bool found_jnt_name;
    double qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q1_psm1_jnt_name,jointState,qval)) g_q_vec(0) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q2_psm1_jnt_name,jointState,qval)) g_q_vec(1) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(d3_psm1_jnt_name,jointState,qval)) g_q_vec(2) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q4_psm1_jnt_name,jointState,qval)) g_q_vec(3) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q5_psm1_jnt_name,jointState,qval)) g_q_vec(4) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q6_psm1_jnt_name,jointState,qval)) g_q_vec(5) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q7_psm1_jnt_name,jointState,qval)) g_q_vec(6) = qval;
    
    if( davinci_fwd_solver.get_jnt_val_by_name(q1_psm2_jnt_name,jointState,qval)) g_q_vec(0) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q2_psm2_jnt_name,jointState,qval)) g_q_vec(1) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(d3_psm2_jnt_name,jointState,qval)) g_q_vec(2) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q4_psm2_jnt_name,jointState,qval)) g_q_vec(3) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q5_psm2_jnt_name,jointState,qval)) g_q_vec(4) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q6_psm2_jnt_name,jointState,qval)) g_q_vec(5) = qval;
    if( davinci_fwd_solver.get_jnt_val_by_name(q7_psm2_jnt_name,jointState,qval)) g_q_vec(6) = qval;
